...
def main():
    ...
    suptit= 'Cartopy Projection Example2 - Global'
    ...
    proj_nms= ['Orthographic(ctr_lat=30)','NorthPolarStereo','NearsidePerspective(ctr_lat=30)','SouthPolarStereo']
    ...
    for i in range(npnx*npny):
        ...
        if proj_nms[i]=='NorthPolarStereo':
            ax1.set_extent([-180,179.9,0,90],crs=data_crs)
        elif proj_nms[i]=='SouthPolarStereo':
