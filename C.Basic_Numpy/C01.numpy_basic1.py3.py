...
print("show_array_info after np.array:")
show_array_info(b)

print('\nshow_array_info after np.asarray:')
show_array_info(c)
print("""
...
print('show_array_info after np.asfarray')
show_array_info(d)
...
print("\n>> f = np.arange(0, 5, 0.5)  # Non-integer increment is possible while not with range()")
f=np.arange(0,5,0.5)
print("show_array_info of f:")
show_array_info(f)
...
print("show_array_info after Transpose:")
show_array_info(h)

print("\n>> h = h.reshape([1,4,3])  # Left-most dim is outer-most ")
h=h.reshape([1,4,3])
print("show_array_info after Reshaping:")
show_array_info(h)

print("\n>> h = h.swapaxes(0,1)  # Swap between axis0 and axis1")
h=h.swapaxes(0,1)
print("show_array_info after swap-axes:")
show_array_info(h)
